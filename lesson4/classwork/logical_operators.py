...
if age >= 13 and has_ticket == "yes": # AND : both conditions must be true for our code inside the if statment to run.
...
if is_raining == "yes" and not has_umbrella == "yes": # Order of operation: first not, then and, then or.
  print("Stay inside. You might get wet!")
elif is_raining == "yes" and has umbrella == "yes":
